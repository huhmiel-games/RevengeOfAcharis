...
//Player
import spritesheetPlayer from '../assets/atlas/adventurerAtlas.png';
import spritesheetPlayerJSON from '../assets/atlas/adventurerAtlas.json';
...
export default class LoadingScreen extends Scene {
    ...
    preload() {
        ...
        // player animation
        this.load.atlas('playerAtlas', spritesheetPlayer, spritesheetPlayerJSON);
