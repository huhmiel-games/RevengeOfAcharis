...
export default class Elevators extends Phaser.GameObjects.Sprite
{
    ...
    public elevatorState: { up: number; down: number; position: any; isMoving: boolean; };
  constructor (scene: GameScene, x: number, y: number, config: { key: string | Phaser.Textures.Texture; up: number; down: number; position: any; }) {
